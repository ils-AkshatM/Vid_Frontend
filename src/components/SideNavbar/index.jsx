...
const SidebarItem = ({ to, icon: Icon, label, isHeader = false }) => (
  <Link
    ...
    className={`flex items-center px-4 py-2 ${
      isHeader ? "text-gray-700 bg-gray-100" : "text-gray-600 hover:bg-gray-200"
    }`}
  >
...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white flex justify-around items-center p-2 shadow-lg">
        {menuItems.map(
          (item, index) =>
